...
<body>
    ...
    <main role="main" class="container mt-4">
        <div id="alert-container" class="alert alert-warning alert-dismissible 
            fade d-none" role="alert">
            <div id="message">&nbsp;</div>
        ...
        $sql = "SELECT id, name, price, description,
             stock_quantity, image_url, category FROM products WHERE id = $id";
                ...
                <div class="col-md-6 preview">
                    <div class="preview-pic">
                        <img src="<?= empty($prod[5]) ?
                                        '/DemoShop/assets/shared/default-image-600.png'
                                        : '/DemoShop/assets/' . $prod[5] ?>" alt="">
                    </div>
